package cn.edu.gdmec.android.webviewdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class AndroidtoJs extends  Object{
        ...
        public void sayHi(String msg){
            Toast.makeText(MainActivity.this,"Javascript传来的数据是："+msg,Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView1.setWebChromeClient(new WebChromeClient(){
            ...
            public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
                Toast.makeText(MainActivity.this, "Javascript传来的数据是" + message, Toast.LENGTH_SHORT).show();
        ...
        mWebView1.setWebViewClient(new WebViewClient(){
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (uri.getScheme().equals("js")){
                    ...
                    Toast.makeText(MainActivity.this,"Javascript传来的数据是"+num,Toast.LENGTH_SHORT).show();
                    return true;
                }
